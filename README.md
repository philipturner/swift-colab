...
To automatically crash and restart the runtime, add the following line to the code cell. You [can also](https://github.com/philipturner/swift-colab/pull/19) restart the runtime with `Cmd/Ctrl + M + .`.
