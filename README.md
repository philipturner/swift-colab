...
> Warning: Some of this documentation may be outdated. Swift-Colab is in the middle of a major overhaul. For a 100% trustworthy guide, check out the README snapshot in [swift-colab-dev](https://github.com/philipturner/swift-colab-dev). To try the faster, undocumented Swift-Colab 2.0, pull from `main` instead of `release/latest` in the first code block described below.
