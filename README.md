...
Coming soon! This task is tracked by https://github.com/philipturner/swift-colab/issues/15. Initial support will likely come from an old fork of S4TF, not the head branch.
