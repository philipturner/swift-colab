...
>
> Docker does not provide access to the user's GPU, unless they have an NVIDIA GPU ([nvidia-docker](https://github.com/NVIDIA/nvidia-docker)). The maintainer wishes to provide all users with an equal set of capabilities, not favoring a specific proprietary API (ahem, CUDA) over all others.
